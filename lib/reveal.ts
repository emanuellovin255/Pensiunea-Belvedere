/* ============================================================
   ...
   Ăsta e PLASA DE SIGURANȚĂ, nu mecanismul principal. Profunzimea și
   intrarea cardurilor se fac în depth.css cu `animation-timeline:
   view()`, care rulează pe compositor și nu are nevoie de JavaScript.
   Fișierul ăsta acoperă browserele care încă n-au `view()`.
