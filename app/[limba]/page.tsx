 ...
 *
 * Motorul deține SEO-ul și JSON-LD-ul (rămân identice pe toate trei
 * șabloanele, T07), încarcă datele o singură dată, apoi predă asamblarea
 * vizuală șablonului ales din `setari.sablon` (T05):
 *
 *   1 → Hero Video (T20)   2 → Poveste alternantă (T21)   3 → Galerie + rezervare (T22)
 *
...
const SABLOANE: Record<1 | 2 | 3, (p: PropsSablon) => ReactNode> = {
  1: SablonHeroVideo,
